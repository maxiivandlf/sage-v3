...
if (previewNode) {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
            url: "http://127.0.0.1:8000/uploadpofmh", // la envio como absoluta de donde llamo local
            ...
            params: {
                _token: csrfToken,
                Agente: document.getElementById("DNI").value,
                CueX: document.getElementById("valCUE").value,
            },
            thumbnailHeight: 80,
            parallelUploads: 20,
