...
if (previewNode) {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        myDropzone.on("sending", function(file, xhr, formData) {
            ...
            formData.append("CueX", document.getElementById("novedad_cue").value); // CueX desde 'novedad_cue'

            // Para depuración: verificar los valores que se están enviando
            console.log("Enviando archivo con Agente:", document.getElementById("DNI").value);
            console.log("Enviando archivo con CueX:", document.getElementById("novedad_cue").value);
        });
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const cells = document.querySelectorAll("#POFMHAsistencia .attendance-cell");
