              ...
              <div class="card-body">
                <div class="tab-content">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="card card-olive">
                                        <div class="card-header">
                                          <h3 class="card-title">Buscar Cargos / Funciones: </h3>
                                          <input type="text" class="form-control" id="btCargos" onkeyup="getCargosFunciones()" placeholder="Ingrese Cargo/Función o Código Salarial">
                                        </div>
                                        <!-- /.card-header -->
                                        <div class="card-body">
                  ...
                  <div class="tab-pane" id="tab_2">
                      {{-- Agente info Inicio--}}
                      <h3>Organización: {{$nombreSubOrg}} - CUE: {{ $CueOrg }}</h3>
...
@section('Script')
    ...
    @if (session('ConfirmarBorradoNodoAnulado')=='OK')
        <script>
        Swal.fire(
            'Se canceló la desvinculación, ese nodo esta relacionado con otro Agente',
