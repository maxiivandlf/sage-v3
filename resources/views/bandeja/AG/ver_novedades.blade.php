            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="alert alert-warning alert-dismissible">
                        ...
                        <input type="hidden" name="valCUE" id="valCUE" value="{{$InstitucionExtension}}">
                    </div>
                    <div class="card card-lightblue">
                        <div class="card-header ">
                            
                            <h3 class="card-title">Novedades - {{$mensaje}}</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                          ...
                          <div class="card-body" >
                              ...
                              <div class="table table-striped files" id="previews">
                                  <div id="template2" class="row mt-2">
                                      ...
                                      Desde esta cuenta no se pueden subir archivos
                                  </div>
                              </div>
                          </div>
                          <!-- /.card-body -->
