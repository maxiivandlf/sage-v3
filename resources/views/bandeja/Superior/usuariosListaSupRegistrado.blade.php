        ...
        <section class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <!-- Buscador Agente -->
                    <h4 class="text-center display-4">Panel de Agentes Registrados</h4>
                                    ...
                                    @foreach ($UsuariosLista as $nag)
                                            ...
                                            <tr>
                                                ...
                                                <td style="display: flex; flex-wrap:wrap;">
                                                    ...
                                                    <a href="{{route('editarUsuarioSup',$nag->idAgente)}}" title="Editar usuario Superior">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <a href="{{route('editarUsuarioSupDocumentos',$nag->idAgente)}}" title="Editar documentos">
