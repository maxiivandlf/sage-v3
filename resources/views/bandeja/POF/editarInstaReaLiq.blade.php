                ...
                <div class="col-md-12">
                    <div class="card card-secondary">
                        <div class="card-header">
                            <h3 class="card-title">Listado Instarealiq (Editable)</h3>
                        </div>
                        <div class="card-body" style="overflow-x: auto;">
                            ...
                            <div class="container-fluid m-1">
                                ...
                                <div class="input-group">
                                    <input type="search" id="searchInput" class="form-control" placeholder="Ingrese el texto a buscar" aria-label="Search">
                                </div>
                                </form>
                            </div>
                                ...
                                <table id="tabla-completa" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr data-id="{{ $dato->ID_inst_area_liq }}">
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-success btn-sm guardar-fila">Guardar</button>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
