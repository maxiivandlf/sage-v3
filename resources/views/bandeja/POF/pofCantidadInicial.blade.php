                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        ...
                                                        //dd($infoCargo);
                                                    @endphp
                                                    {{ $infoCargo->nombre_cargo_origen}}
                                                </td>
                                                <td>
                                                    @php
                                                    $cueMinimo =  substr($i->CUECOMPLETO, 0, 7);
                                                        $infoCantidad = DB::connection('DB7')->table('tb_padt')
                                                            ->where('idOrigenCargo', $i->idOrigenCargo)
                                                            ->where('CUECOMPLETO', 'like', $cueMinimo.'%')
                                                            ->count(); 
                                                    @endphp
                                                    {{ $infoCantidad }}
                                                </td>
