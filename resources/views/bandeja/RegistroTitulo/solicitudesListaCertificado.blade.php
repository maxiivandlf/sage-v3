                ...
                <div class="col-md-12">
                    <div class="card card-lightblue">
                        ...
                        @php
                            ...
                            ->join('tb_agentes','tb_agentes.dni','tb_registro_de_certificados.dni')
                            ->orderby('tb_registro_de_certificados.created_at','desc')
                            ->get();
                        @endphp
                        <!-- /.card-header -->
                        <div class="card-body table-responsive">
                            <table id="certificadosTab" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th colspan="6" style="text-align: center">DOCUMENTO SOLICITADO: <b>CERTIFICADO</b></th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td>{{ \Carbon\Carbon::parse($o->fecha_de_certificado)->format('d-m-Y') }}</td>
