                ...
                <div class="col-md-12">
                    <div class="card card-lightblue">
                        <div class="card-header">
                            ...
                            Panel de Control - Editar Título/Certificado
                            </h3>
                        </div>
                        <!-- /.card-header -->
                            ...
                            <div class="card-body">
                                <div class="row" style="display: flex;justify-content: center;gap: 100px;">
                                    <div class="form-group">
                                        ...
                                        <input required type="date" class="form-control" id="fechaRegistro" name="fechaRegistro" placeholder="Ingrese Descripción" value="{{ \Carbon\Carbon::parse($infoRegTitulo->fecha_de_registro)->format('Y-m-d')}}">
                                    </div> 
                                    <div class="form-group">
                                        <label for="ultimoTitulo">Titulo - Registro Siguiente</label>
                                        <input required type="text" class="form-control" id="ultimoTitulo" name="ultimoTitulo" placeholder="Ingrese Descripción" value="{{$infoRegTitulo->idRegistroTitulo}}">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="row col-12"> 
                                    ...
                                    <div class="form-group col-3">
                                        ...
                                        <input required type="date" class="form-control" id="fecha" name="fecha" placeholder="Ingrese fecha descriptiva" value="{{\Carbon\Carbon::parse($infoRegTitulo->fecha_de_titulo)->format('Y-m-d')}}">
                                    </div>
                                ...
                                <div class="row col-12">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input required type="date" class="form-control" id="fechaEgreso" name="fechaEgreso" placeholder="Ingrese fecha descriptiva" value="{{\Carbon\Carbon::parse($infoRegTitulo->fecha_de_egreso)->format('Y-m-d')}}">
                                    </div>
                                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td style="display: flex;justify-content: space-between;align-items: center;">
                                            ...
                                            @endif
                                            |
                                            <a style="margin-right: 5px"  class="agregar-enlace" href="{{route('agregarDocAgenteTitulo',$Agentes->idAgente)}}" title="Agregar Mas Documentos" data-id="{{$Agentes->idAgente}}">
                                                <i class="fa fa-upload" style="color: green"></i>
                                            </a>
                                            |
                                            <a style="margin-right: 5px"  class="agregar-enlace" href="{{route('editarTituloCreado',$o->idRegistroTitulo)}}" title="Editar" data-id="{{$o->idRegistroTitulo}}">
                                                <i class="fa fa-upload" style="color: green"></i>
                                            </a>
