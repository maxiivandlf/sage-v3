                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="form-group">
                                                ...
                                                @if ($nag->PermiteBorrarTodo ==1 )
                                                <div class="form-group clearfix">
                                                    <div class="icheck-danger d-inline">
                                                      <input type="radio" name="r{{$nag->idInstitucionExtension}}"  id="radioSuccess{{$nag->idInstitucionExtension}}">
                                                      <label for="radioSuccess{{$nag->idInstitucionExtension}}">
                                                      </label>
                                                    </div>
                                                    <div class="icheck-success d-inline">
                                                      <input type="radio" name="r{{$nag->idInstitucionExtension}}" checked="" id="radioSuccessx{{$nag->idInstitucionExtension}}">
                                                      <label for="radioSuccessx{{$nag->idInstitucionExtension}}">
                                                      </label>
                                                    </div>
                                                  </div>
                                                ...
                                                @else
                                                    <div class="form-group clearfix">
                                                        <div class="icheck-danger d-inline">
                                                        <input type="radio" name="r{{$nag->idInstitucionExtension}}"  checked=""id="radioSuccess{{$nag->idInstitucionExtension}}">
                                                        <label for="radioSuccess{{$nag->idInstitucionExtension}}">
                                                        </label>
                                                        </div>
                                                        <div class="icheck-success d-inline">
                                                        <input type="radio" name="r{{$nag->idInstitucionExtension}}"  id="radioSuccessx{{$nag->idInstitucionExtension}}">
                                                        <label for="radioSuccessx{{$nag->idInstitucionExtension}}">
                                                        </label>
                                                        </div>
                                                    </div>
