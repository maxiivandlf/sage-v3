            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="alert alert-warning alert-dismissible">
                        ...
                        Sino aparecen escuelas, es porque no hay escuelas en su cuenta con datos faltantes</h3>
                    </div>
                    <!-- Buscador Agente -->
                    <h4 class="text-center display-4">Panel de Escuelas con Datos Incompletos del Técnico</h4>
                            ...
                            <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($Escuelas as $nag)
                                        @if ($nag->idTecnicoSage == session('idUsuario'))
                                        <tr>
