 ...
 <div class="row" style="position: absolute;top:10px; left:150px;z-index:0;">
  <marquee style="color:red;font-size:24px;">Fin de Mantenimiento, Novedad y Pof estructural en Funcionamiento  . Gracias
    ...
    <div class="card text-center bg-op-1 margin-bottom" style="width: 420px">
      ...
      <div class="card-body">
        <h1><strong style="color:rgb(74, 71, 71)">Sistema <strong><strong style="color: rgb(102, 78, 78)">SAGE</strong></h1>
        ...
        @else
          ...
          <p class="mt-2" style="text-align: left;">
            <label>No tiene un Usuario Multicuenta?</label> <a href="{{route('preregistroDocente')}}" class="text-center">CLICK para Registrarlo</a>
          </p>
          {{-- <p class="mt-2" style="text-align: left;">
    ...
    <div class="card text-center bg-op-1 p-2" style="width: 420px">
      <div class="label-container">
        ...
        Disponible <span class="circle green"> <i class="fas fa-check-circle" style="color: green;" title="Online"></i> </span>
      </div>
      <div class="label-container">
        <label>Modalidad Movil</label>
        No Disponible <span class="circle red"><i class="fas fa-times-circle" style="color: red;" title="Offline"></i> </span>
      </div>
    </div>
