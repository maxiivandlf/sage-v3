                        ...
                        <div class="tab-pane active" id="settings">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input  disabled type="text" class="form-control" id="documento" name="documento" placeholder="Ingrese DNI"  value="{{$InfoUsuario->Documento}}"><span style="color: red">* No se puede cambiar, debe consultar a sage@educacionlarioja.com</span>
                                </div>
                              </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="usuario" class="col-sm-2 col-form-label">ROL/Usuario/Descripción</label>
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="usuario" placeholder="Ingrese ROL/Usuario/Descripcion" name="usuario"  value="{{$InfoUsuario->Usuario}}">
                                </div>
                              </div>
                            <div class="form-group row">
