...
<div class="container">
	<div class="left-section">
		<div class="inner-content">
			...
			<p class="subheading">La página solicitada No Existe. Esto se puede deber a un problema de direccionamiento o de intrusión.
			<br>
			Igualmente esta acción sera guardada con IP para ser analizadas por los moderadores de turno.
			<br><br>
			Haga click para ser redirecionado al Inicio del Sitio Web 
			<a href="{{route('Autenticar')}}"  style="color:greenyellow" >
				<i class="fa fa-home"></i>SAGE
			</a>
</p>
		</div>
	</div>
